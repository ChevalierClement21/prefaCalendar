                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.sectors.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600">{{ old('description') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex space-x-2 mt-1">
                                <x-text-input id="color" class="w-full" type="text" name="color" :value="old('color', '#3B82F6')" placeholder="#RRGGBB" />
                                <input type="color" class="h-10 w-10 rounded" id="color-picker" value="{{ old('color', '#3B82F6') }}">
                            </div>
