...
class SectorControllerTest extends TestCase
{
    ...
    /**
     * Test that unauthorized users cannot access the sectors index.
     */
    public function test_unauthorized_users_cannot_access_sectors_index(): void
    {
     ...
     */
    public function test_validation_rejects_invalid_color_format(): void
    {
        $admin = $this->createAdminUser();
